      ...
      child: Scaffold(
        ...
        body: Consumer<ProfileProvider>(
            builder: (context, profileProvider, _) {
                            ...
                            children: [
                              ...
                              SingleChildScrollView(
                                child: Column(children: [
                                  SizedBox(width: Dimensions.WEB_SCREEN_WIDTH, child: Column(
                                    children: [
                                                      ...
                                                      builder: (context, walletProvider, _) {
                                                        return Column(children: [
                                                          Column(children: [
                                                            ...
                                                            walletProvider.transactionList != null ? walletProvider.transactionList.length > 0 ? GridView.builder(
                                                              ...
                                                              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                                ...
                                                                childAspectRatio: widget.fromWallet
                                                                    ? !ResponsiveHelper.isMobile(context) ?  3.6 : 3
                                                            ...
                                                            ) : NoDataScreen(isSearch: true) : WalletShimmer(walletProvider: walletProvider),
              ...
              ) : Center(child: CustomLoader(color: Theme.of(context).primaryColor)) : NotLoggedInScreen();
            }
        ),
      ),
    );
