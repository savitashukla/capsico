                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                  ...
                                  Text('${_isVatInclude ? '' : '(+)'} ${PriceConverter.convertPrice(context, _tax)}', style: poppinsRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                ]),
                                SizedBox(height: 10),
                                          ...
                                          onPressed: () {
                                            showDialog(context: context, barrierDismissible: false, builder: (context) => OrderCancelDialog(
                                              ...
                                              callback: (String message, bool isSuccess, String orderID) {
                                                if (isSuccess) {
                                                  Provider.of<ProductProvider>(context, listen: false).getItemList(context, '1',
              ...
              child: Center(child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('${getTranslated('tax', context)} ${_isVatInclude
