...
class ConfigModel {
  ...
  ConfigModel(
    ...
    this._loyaltyPointItemPurchasePoint = loyaltyPointItemPurchasePoint;
    this._loyaltyPointStatus = _loyaltyPointStatus;
    this._loyaltyPointMinimumPoint = loyaltyPointMinimumPoint;
    this._loyaltyPointExchangeRate = loyaltyPointExchangeRate;
    this._referEarningStatus = referEarningStatus;
    this._walletStatus = walletStatus;
    this._whatsapp = whatsapp;
    this._cookiesManagement = cookiesManagement;
    this._activePaymentMethodList = activePaymentMethodList;
    this._offlinePayment = offlinePayment;
    this._freeDeliveryOverAmount = freeDeliveryOverAmount;
    this._maxOrderForCODAmount = maxOrderForCODAmount;
    this._freeDeliveryStatus = freeDeliveryStatus;
    this._isVatTexInclude = isVatTexInclude;
    this._returnPolicy = returnPolicy;
    this._refundPolicy = refundPolicy;
    this._cancellationPolicy = cancellationPolicy;
    this._telegram = telegram;
    this._messenger = messenger;
    this._featuredProductStatus = featuredProductStatus;
    this._trendingProductStatus = trendingProductStatus;
    this._mostReviewedProductStatus = mostReviewedProductStatus;
    this._recommendedProductStatus = recommendedProductStatus;
    this._maxAmountCodStatus = maxAmountCodStatus;
    this._flashDealProductStatus = flashDealProductStatus;
    this._cancellationPolicyStatus = cancellationPolicyStatus;
    this._refundPolicyStatus = refundPolicyStatus;
    this._returnPolicyStatus = returnPolicyStatus;
  }
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    _cookiesManagement = json['cookies_management'] != null
        ? new CookiesManagement.fromJson(json['cookies_management'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['loyalty_point_item_purchase_point'] = this._loyaltyPointItemPurchasePoint;
    ...
    data['ref_earning_status'] = this._referEarningStatus;
    data['wallet_status'] = this._walletStatus;
    if (this._whatsapp != null) {
      data['whatsapp'] = this._whatsapp.toJson();
    }
    if (this._cookiesManagement != null) {
      data['cookies_management'] = this._cookiesManagement.toJson();
    }
    data['product_vat_tax_status'] = this._isVatTexInclude;
    return data;
  }
}
...
class BaseUrls {
  ...
  BaseUrls(
    ...
    this._flash_sale_imageUrl = flash_sale_imageUrl;
  }
  ...
  String get flash_sale_imageUrl => _flash_sale_imageUrl;
  ...
  BaseUrls.fromJson(Map<String, dynamic> json) {
    ...
    _flash_sale_imageUrl = json['flash_sale_image_url'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['flash_sale_image_url'] = this._flash_sale_imageUrl;
    return data;
  }
}
